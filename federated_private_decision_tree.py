...
class FederatedPrivateDecisionTree:
    def __init__(self, max_depth=5, min_samples_split=2, num_quantiles=10, privacy_budget=1, diff_privacy = True, leaf_mechanism='laplace'):
    ...
    def __best_split(self, X, y):
        ...
        best_threshold = None
        for feature in range(n_features):
            # Bin the feature according to the quantiles
